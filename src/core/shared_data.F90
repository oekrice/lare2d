...
MODULE shared_data
  ...
  !My read-in data from the variables file
  REAL(num):: energy_variable
  REAL(num):: outflow_variable
  REAL(num):: bfact_variable
  REAL(num):: density_variable
  REAL(num):: shearfact_variable
  REAL(num):: eta0_variable
  REAL(num):: grav_variable
  REAL(num):: nplots
  REAL(num):: run_num
